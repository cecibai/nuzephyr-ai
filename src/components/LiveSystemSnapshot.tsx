  ...
  return (
    <section className="py-20 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Desktop Computer Frame with Scrolling Content */}
        <motion.div
        ...
        >
          ...
          <div className="relative">
            ...
            {/* Screen glow effect */}
            <motion.div
              className="absolute blur-xl opacity-20 pointer-events-none"
              style={{
                top: "11.25%",
                left: "7.5%",
                width: "85%",
...
function ModuleCard({ module }: { module: typeof modules[0] }) {
  ...
  return (
    <Card className={`p-6 bg-white/95 backdrop-blur-sm border-2 ${colors.border} shadow-2xl ${colors.shadow}`}>
      ...
      <h3 className="text-gray-900 mb-6 text-2xl">{module.name}</h3>

      <div className="space-y-4">
        <div>
          <div className="text-gray-500 text-sm mb-1">Throughput</div>
          <div className={`text-3xl ${colors.text}`}>
            {count.toLocaleString()}<span className="text-base text-gray-500">/min</span>
          </div>
        </div>

        <div>
          <div className="text-gray-500 text-sm mb-1">Response Time</div>
          <div className={`text-2xl ${colors.text}`}>{module.responseTime}s</div>
        </div>
      </div>
